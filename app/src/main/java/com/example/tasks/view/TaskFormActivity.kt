...
class TaskFormActivity : AppCompatActivity(), View.OnClickListener,
    ...
    private fun observe() {
        ...
        mViewModel.validation.observe(this, androidx.lifecycle.Observer {
            if(it.sucess()){
                if(mTaskId == 0)Toast.makeText(this,getString(R.string.task_created),Toast.LENGTH_SHORT).show()
                else Toast.makeText(this,getString(R.string.task_updated),Toast.LENGTH_SHORT).show()
                finish()
            }else{
